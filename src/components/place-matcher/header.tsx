    ...
    >
      <div className="flex min-w-0 items-center gap-3 md:gap-6">
        ...
        <div className="flex min-w-0 items-center gap-2">
          <div className="size-8 shrink-0 bg-[#171417] rounded-md flex items-center justify-center text-white text-[10px] font-bold leading-none">
            <span className="text-[8px]">F</span>
            <span className="text-[10px] ml-px">sq</span>
          </div>
          <span className="text-[16px] leading-[24px] font-semibold text-foreground truncate">
            /placemaker
          </span>
          <span className="hidden sm:inline-flex text-[12px] leading-[16px] font-medium text-muted-foreground border border-border rounded px-1.5 py-0.5">
            Beta
          </span>
        </div>
      ...
      <div className="flex shrink-0 items-center gap-1 md:gap-3">
        <button className="hidden md:block p-1.5 hover:bg-muted rounded-md">
